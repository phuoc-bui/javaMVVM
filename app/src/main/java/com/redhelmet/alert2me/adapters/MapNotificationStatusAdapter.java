...
public class MapNotificationStatusAdapter extends BaseAdapter {
    ...
    public MapNotificationStatusAdapter(Activity act, ArrayList<Category> categoryArray, int selectedCategory, int selectedType) {
        this.activity=act;
