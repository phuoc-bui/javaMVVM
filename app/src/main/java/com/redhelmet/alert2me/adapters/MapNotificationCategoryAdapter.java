...
public class MapNotificationCategoryAdapter extends BaseAdapter {
    ...
    public MapNotificationCategoryAdapter(Activity context, ArrayList<Category> category_data) {
