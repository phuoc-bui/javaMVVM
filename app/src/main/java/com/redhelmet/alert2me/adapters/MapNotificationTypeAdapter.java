...
public class MapNotificationTypeAdapter extends BaseAdapter {
    ...
    public MapNotificationTypeAdapter(Activity activity, ArrayList<Category> categoryData, int selectedCategory) {
