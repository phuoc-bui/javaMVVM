...
public class SplashScreen extends BaseActivity<SplashViewModel, ActivitySplashScreenBinding> implements NetworkStateReceiver.NetworkStateReceiverListener {
    RequestQueue queue;
    ...
    @Override
    protected SplashViewModel
    obtainViewModel() {
        return ViewModelProviders.of(this, new ViewModelFactory(viewModel)).get(SplashViewModel.class);
    }
