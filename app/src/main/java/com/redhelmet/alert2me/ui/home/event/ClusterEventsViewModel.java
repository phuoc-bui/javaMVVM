...
public class ClusterEventsViewModel extends BaseViewModel {
    ...
    public void onEventClick(int position) {
        if (position < events.get().size()) {
            ...
            if (event != null)
                navigationEvent.setValue(new com.redhelmet.alert2me.global.Event<>(NavigationType.START_ACTIVITY.setData(EventDetailsActivity.class, EventDetailsActivity.createDataBundle(event))));
        }
    }
}
